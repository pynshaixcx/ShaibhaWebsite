                ...
                <div class="footer-sections">
                    <div class="footer-section">
                        <div class="footer-brand">
                            <h3 class="brand-title">ShaiBha</h3>
                            <p class="brand-description">Curating pre-loved fashion with character, sustainability, and style at the forefront of everything we do.</p>
                    ...
                    <div class="footer-section">
                        ...
                        <ul class="footer-links">
                            <li><a href="/shop/category.php?cat=dresses" class="footer-link">Dresses</a></li>
                            <li><a href="/shop/category.php?cat=tops" class="footer-link">Tops & Blouses</a></li>
                            <li><a href="/shop/category.php?cat=outerwear" class="footer-link">Outerwear</a></li>
                            <li><a href="/shop/category.php?cat=accessories" class="footer-link">Accessories</a></li>
                    ...
                    <div class="footer-section">
                        ...
                        <ul class="footer-links">
                            <li><a href="/services/size-guide.php" class="footer-link">Size Guide</a></li>
                            <li><a href="/services/care-instructions.php" class="footer-link">Care Instructions</a></li>
                            <li><a href="/services/styling-tips.php" class="footer-link">Styling Tips</a></li>
                            <li><a href="/pages/shipping-policy.php" class="footer-link">Shipping Policy</a></li>
                            <li><a href="/pages/return-policy.php" class="footer-link">Return Policy</a></li>
                        </ul>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="footer-bottom-content">
                    <p class="copyright">&copy; <?php echo date('Y'); ?> ShaiBha. All rights reserved.</p>
                    <p class="sustainability-message">Sustainable fashion for a better tomorrow.</p>
                </div>
            </div>
        </div>
    </footer>
